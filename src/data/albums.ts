export const albums = [
  {
    slug: "all-lights-fucked-on-the-hairy-amp-drooling",
    title: "All Lights Fucked on the Hairy Amp Drooling",
    year: "1994",
    kind: "cassette / archival release",
  ...
  {
    slug: "slow-riot-for-new-zero-kanada",
  ...
  {
    slug: "lift-your-skinny-fists-like-antennas-to-heaven",
  ...
  {
    slug: "allelujah-dont-bend-ascend",
    title: "'Allelujah! Don't Bend! Ascend!",
    year: "2012",
    kind: "studio album",
    image: "/images/albums/allelujah.jpg",
    label: "Constellation",
    summary:
  ...
  {
    slug: "asunder-sweet-and-other-distress",
  ...
  {
    slug: "g_ds-pee-at-states-end",
    title: "G_d's Pee AT STATE'S END!",
    year: "2021",
    kind: "studio album",
    image: "/images/albums/gds-pee.jpg",
    label: "Constellation",
    summary:
  ...
  {
    slug: "no-title-as-of-13-february-2024-28-340-dead",
